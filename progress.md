...
- **TikTok-clarity quick win (sep 2026):** fan-carousel cards tonen echte `@handle`s uit `SHOWER_CHANNELS` (geen fake handles). Navbar: compact musical-note + typographic “TikTok” naast logo (geen officieel TikTok-logo-bestand). Bestaande cards blijven; `TikTokPhoneFeed` niet op homepage.

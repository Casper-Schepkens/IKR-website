  ...
  return (
    <section style={{ backgroundColor: 'var(--ikr-cream-light)' }} className="pb-24">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="rounded-3xl p-8 md:p-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-8"
          ...
          <Link href="/contact"
            className="w-full md:w-auto justify-center shrink-0 font-display font-black px-8 h-16 rounded-full flex items-center text-lg whitespace-nowrap hover:opacity-90 transition-opacity"
